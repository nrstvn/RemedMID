        ...
        <div className="d-flex flex-column">
          <div className="profile">
            ...
            <h1 className="text-light">
              <a href="index.html">Devan Prabowo</a>
            </h1>
            <div className="social-links mt-3 text-center">
              <a href="https://twitter.com/devanprabowo1" className="twitter">
                <i className="bx bxl-twitter" />
              </a>
              <a href="https://www.facebook.com/DevanChPrabowo" className="facebook">
                <i className="bx bxl-facebook" />
              </a>
              <a href="https://www.instagram.com/devanprabowo1" className="instagram">
